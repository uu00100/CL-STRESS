'''
Data Pre-processing on beam dataset.
...
def load_domain_data(domain_idx):
    ...
    """
    data_dir = './data/beam/'
    saved_filename = 'beam_domain_' + domain_idx + '_wd.data' # "wd": with domain label
